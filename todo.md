...
- P2-A live preflight passed for one Codex and one Claude smoke task; retain the Codex rollout fallback and keep the combined economic verdict inconclusive until a provider-reported USD cost exists.
