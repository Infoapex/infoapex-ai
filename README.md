![Infoapex AI — arhitectura curentă](docs/assets/infoapex-ai-current-architecture-illustrated-ro-control-flow.png)
...
> Baseline-ul pre-P5 este stabilit, iar primul candidat P5 — OpenTelemetry redactat —
> a primit verdictul intern direcțional `ACCEPT` pe 20/20 observații valide. Modulul
> benchmark standalone este publicat și pinned; P5 continuă per subproiect. Vezi
...
| **P6** | [Production Readiness & Developer Adoption](docs/plans/INFOAPEX-AI-P6-PRODUCTION-READINESS-PLAN.md): lifecycle, security, recovery, operare, suport și pilot consumator | 🟡 în curs — profilul solo-maintainer pentru RC intern este implementat; publicarea și pilotul enterprise rămân separate |
